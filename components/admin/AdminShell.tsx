...
const nav = [
  ...
  { href: "/admin/flags", label: "פיצ׳רים פעילים", icon: "🧩" },
  { href: "/admin/health", label: "בדיקת מערכת", icon: "🧪" },
  { href: "/admin/audit", label: "יומן וסל מיחזור", icon: "🛡️" },
  ...
  { href: "/admin/segments", label: "סגמנטים וציון", icon: "🎯" },
